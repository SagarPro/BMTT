...
public class UsersListAdapter extends BaseAdapter {
    ...
    public UsersListAdapter(Context context, List<String> usersList, HashMap<String, String> userCentre, HashMap<String, String> userPic) {
