...
public class MilestoneBmttPart2 extends Fragment {

    private static Map<String, List<String>> videosList = new HashMap<>();
    private static HashMap<String, Integer> videoCount = new HashMap<>();

    public MilestoneBmttPart2(){

    }

    public static MilestoneBmttPart2 newInstance(Map<String, List<String>> list, HashMap<String, Integer> count) {
        Bundle args = new Bundle();
        MilestoneBmttPart2 fragment = new MilestoneBmttPart2();
