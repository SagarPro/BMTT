...
public class MilestoneBmttPart1 extends Fragment {

    private static Map<String, List<String>> videosList = new HashMap<>();
    private static HashMap<String, Integer> videoCount = new HashMap<>();

    public MilestoneBmttPart1(){

    }

    public static MilestoneBmttPart1 newInstance(Map<String, List<String>> list, HashMap<String, Integer> count) {
        Bundle args = new Bundle();
        MilestoneBmttPart1 fragment = new MilestoneBmttPart1();
