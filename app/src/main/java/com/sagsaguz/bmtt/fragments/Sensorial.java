...
public class Sensorial extends Fragment {
    ...
    public static Sensorial newInstance(ActivitiesDO act, List<String> list) {
        Bundle args = new Bundle();
        Sensorial fragment = new Sensorial();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        ActivitiesAdapter activitiesAdapter = new ActivitiesAdapter(getContext(), activitiesDO, sensorialList);
